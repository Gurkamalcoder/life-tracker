...
def collect_xp():
    ...
    if n == "yes":
        ...
        # after marking everything complete we simply return the xp total;
        # the caller (ask_quests) will print added info if desired
        return total_xp
        ...
        # the xp has been computed and stats updated; return it
        return gained_xp
