...
def total_progress():
    ...
    formattime = today.strftime("%H:%M:%S")
    if day_number <= 90:
            print_centered(f"White room ARC >>> phase 1/Phase 8 ||Day : {day_number}")
    elif day_number <= 180:
            print_centered(f"White room ARC >>> phase 2/Phase 8 ||Day : {day_number}")
    elif day_number <= 270:
            print_centered(f"White room ARC >>> phase 3/Phase 8 ||Day : {day_number}")
    elif day_number <= 360:
            print_centered(f"White room ARC >>> phase 4/Phase 8 ||Day : {day_number}")
    elif day_number <= 450:
            print_centered(f"White room ARC >>> phase 5/Phase 8 ||Day : {day_number}")
    elif day_number <= 540:
            print_centered(f"White room ARC >>> phase 6/Phase 8 ||Day : {day_number}")
    elif day_number <= 630:
            print_centered(f"White room ARC >>> phase 7/Phase 8 ||Day : {day_number}")
    elif day_number <= 720:
            print_centered(f"White room ARC >>> phase 8/Phase 8 ||Day : {day_number}")
    else:
            print_centered("Phase complete!")
